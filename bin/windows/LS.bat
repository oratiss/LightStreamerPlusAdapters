@echo off
rem Do not remove this line. File tag: windows_launch-APV-7.2.0.
...
:doForeground
   ...
   set command=%JAVA% %JAVA_OPTS% %KERNEL_LIB_PATH% %INTERNAL_LIB_PATH% %LOGGING_LIB_PATH% %MPN_LIB_PATH% -cp %cpath% %class% %args%
   %command%
   goto end
