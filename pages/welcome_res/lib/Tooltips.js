...
var tooltipMessages = {
    javascript_client:"To connect your web application to Lightstreamer Server, you just need to include a JavaScript library, which is provided together with extensive documentation and example code. The Web library supports any browsers and most standards (npm, UMD, ES Module, CommonJS, TypeScript, React Native, and more).",
